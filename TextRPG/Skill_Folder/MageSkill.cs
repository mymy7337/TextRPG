                ...
                case 1: // 파이어볼
                    {
                        ...
                        Console.WriteLine($"[마법사] '파이어볼' 발사! {monster.Name}에게 {damage}의 화염 피해! (MP -{mpCost})");
                ...
                case 2: // 얼음 화살
                    {
                        ...
                        Console.WriteLine($"[마법사] '얼음 화살' 발사! {monster.Name}에게 {damage}의 냉기 피해! (MP -{mpCost})");
                        monster.TakeDamage(damage);
                        break;
                    }
                ...
                case 3: // 마나 폭발
                    {
                        ...
                        Console.WriteLine($"[마법사] '마나 폭발'! {monster.Name}에게 {damage}의 강력한 마법 피해! (MP -{mpCost})");
                        monster.TakeDamage(damage);
                        break;
                    }

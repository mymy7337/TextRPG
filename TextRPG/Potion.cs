...
public class Potion : Item
{
    ...
    {
        new Potion("체력포션(소)", "체력을 아주 조금 회복해준다.", 2, GetType.Shop, new int[]{5}, new EffectType[] { EffectType.ItemHp }),
        new Potion("마력포션(소)", "마력을 아주 조금 회복해준다.", 2, GetType.Shop, new int[]{5}, new EffectType[] { EffectType.ItemMp }),
